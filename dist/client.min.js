...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Navigate = __webpack_require__(167);
	...
	*/
	_reactDom2.default.render(_react2.default.createElement(_Navigate2.default, null), nav);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Keyword = __webpack_require__(160);

	var _Keyword2 = _interopRequireDefault(_Keyword);

	var _Rating = __webpack_require__(162);

	var _Rating2 = _interopRequireDefault(_Rating);

	var _ReviewList = __webpack_require__(163);

	var _ReviewList2 = _interopRequireDefault(_ReviewList);

	var _Total = __webpack_require__(164);

	var _Total2 = _interopRequireDefault(_Total);

	var _LoadMore = __webpack_require__(165);

	var _LoadMore2 = _interopRequireDefault(_LoadMore);

	var _LoadingSpinner = __webpack_require__(166);
	...
	var Layout = function (_React$Component) {
	  ...
	  function Layout(props) {
	    ...
	    _this.state = {
	      ...
	      total: 0,
	      pages: 1,
	      url: ("http://exercises.appfigures.com/reviews"),
	      keyword: '',
	      rating: ''
	    };
	  ...
	  _createClass(Layout, [{
	    ...
	    value: function onBlur(event) {
	      ...
	      function updateURLWithKeyword() {
	        ...
	        var fetchReviews = fetch(url, { credentials: 'same-origin' });
	      ...
	      this.setState({
	        ...
	        return updateURLWithKeyword();
	      });
	    }
	  }, {
	    key: 'sectionReviews',
	    value: function sectionReviews() {
	      ...
	      this.state.reviews.forEach(function (review) {
	        var date = review.date.substring(0, 10).replace(/-/g, '\/');
	        var reviewDate = new Date(date);

	        var _ref = keys.find(function (_ref3) {
	          var _ref4 = _slicedToArray(_ref3, 2),
	              header = _ref4[0],
	              headerDate = _ref4[1];

	          return reviewDate >= headerDate;
	        }) || [],
	            _ref2 = _slicedToArray(_ref, 2),
	            key = _ref2[0],
	            keyDate = _ref2[1];

	        var dynamicKey = reviewDate.getMonth() + '/' + reviewDate.getFullYear();
	        ...
	        if (key) {
	          // if key is not null we are using our manually made keys
	          if (!(key in reviewTypeList)) {
	            reviewTypeList[key] = [];
	          }
	          reviewTypeList[key].push(review);
	        } else {
	          // if keys is null we are using our dynamicKeys
	      ...
	      this.setState({ reviewTypeList: reviewTypeList });
	      console.log(reviewTypeList);
	    }
	  }, {
	    key: 'generateURL',
	    value: function generateURL(host, pages, keyword, rating) {
	      var url = '';
	      if (keyword === '' && rating === '') {
	        url = host + '?page= ' + pages;
	      } else if (keyword === '') {
	    ...
	    value: function handleLoadMore() {
	      ...
	      this.setState({
	        ...
	        return loadPaginatedMessages();
	      });
	    }
	  }, {
	    key: 'handleRating',
	    value: function handleRating(evt) {
	      var self = this;
	    ...
	    */
	    ...
	    value: function render() {
	      return Object.keys(this.state.reviewTypeList).length ? _react2.default.createElement(
	        'div',
	        { id: 'componentLayout' },
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col-xs-8' },
	            _react2.default.createElement(_Keyword2.default, { onBlur: this.onBlur })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'col-xs-2' },
	            _react2.default.createElement(_Rating2.default, { rating: this.state.rating, handleRating: this.handleRating })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col-xs-10' },
	            _react2.default.createElement(_Total2.default, { total: this.state.total }),
	            _react2.default.createElement(_ReviewList2.default, { reviewTypeList: this.state.reviewTypeList })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col-xs-10' },
	            _react2.default.createElement(_LoadMore2.default, { handleLoadMore: this.handleLoadMore })
	          )
	        )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MyPropTypes = __webpack_require__(161);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function Keyword(props) {
	  Keyword.propTypes = {
	    onBlur: _MyPropTypes.PropOnBlur.isRequired
	  };
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'label',
	      { className: 'sr-only', htmlFor: 'inputKeyword' },
	      'keyword'
	    ),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.PropRating = exports.PropHandleRating = exports.PropTotal = exports.PropHandleLoadMore = exports.PropOnBlur = exports.PropReviewTypeList = undefined;

	var _react = __webpack_require__(1);

	var PropReviewTypeList = exports.PropReviewTypeList = _react.PropTypes.shape({
	  'Today/10006': _react.PropTypes.arrayOf(_react.PropTypes.object),
	  'Yesterday/10005': _react.PropTypes.arrayOf(_react.PropTypes.object),
	  'This Week/10004': _react.PropTypes.arrayOf(_react.PropTypes.object),
	  'Last Week/10003': _react.PropTypes.arrayOf(_react.PropTypes.object),
	  'This Month/10002': _react.PropTypes.arrayOf(_react.PropTypes.object),
	  'Last Month/10001': _react.PropTypes.arrayOf(_react.PropTypes.object)
	});

	var PropOnBlur = exports.PropOnBlur = _react.PropTypes.func;
	var PropHandleLoadMore = exports.PropHandleLoadMore = _react.PropTypes.func;
	var PropTotal = exports.PropTotal = _react.PropTypes.number;
	var PropHandleRating = exports.PropHandleRating = _react.PropTypes.func;
	var PropRating = exports.PropRating = _react.PropTypes.string;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Rating(props) {
	  Rating.propTypes = {
	    rating: _MyPropTypes.PropRating.isRequired,
	    handleRating: _MyPropTypes.PropHandleRating.isRequired
	  };
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'label',
	          { className: 'sr-only', htmlFor: 'selectRating' },
	          'Select Rating:'
	        ),
	        _react2.default.createElement(
	          'select',
	          { className: 'form-control', value: props.rating, onChange: props.handleRating, id: 'selectRating' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function ReviewList(props) {
	  ReviewList.propTypes = {
	    reviewTypeList: _MyPropTypes.PropReviewTypeList.isRequired
	  };

	  return _react2.default.createElement(
	    'div',
	    { id: 'componentReviewList' },
	    Object.keys(props.reviewTypeList).sort(function (a, b) {
	      var yearA = a.split('/').map(Number)[1];
	      var yearB = b.split('/').map(Number)[1];
	      var monthA = a.split('/').map(Number)[0];
	      var monthB = b.split('/').map(Number)[0];
	      if (yearB === yearA) {
	      ...
	      if (key === 'Today/10006' || key === 'Yesterday/10005' || key === 'This Week/10004' || key === 'Last Week/10003' || key === 'This Month/10002' || key === 'Last Month/10001') {
	        header = key.split('/')[0];
	      } else {
	        var monthObj = {
	          0: 'Jan',
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          props.reviewTypeList[key].map(function (review) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Total(props) {
	  Total.propTypes = {
	    total: _MyPropTypes.PropTotal.isRequired
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function LoadMore(props) {
	  LoadMore.propTypes = {
	    handleLoadMore: _MyPropTypes.PropHandleLoadMore.isRequired
	  };

	  return _react2.default.createElement(
	    'div',
	    { id: 'componentLoadMore' },
	    _react2.default.createElement(
	      'button',
	      { id: 'buttonLoadMore', onClick: props.handleLoadMore },
	      'Load More Reviews'
	    )
	  );
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Navigate = function (_Component) {
	  _inherits(Navigate, _Component);

	  function Navigate() {
	    _classCallCheck(this, Navigate);

	    return _possibleConstructorReturn(this, (Navigate.__proto__ || Object.getPrototypeOf(Navigate)).apply(this, arguments));
	  }
	...
	var Address = function Address() {
	  return _react2.default.createElement(
	    'h1',
	    null,
	    'We are located at Somewhere Over The Rainbow'
	  );
	};
