...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Rating = __webpack_require__(161);

	var _Rating2 = _interopRequireDefault(_Rating);

	var _ReviewList = __webpack_require__(162);

	var _ReviewList2 = _interopRequireDefault(_ReviewList);

	var _Total = __webpack_require__(163);

	var _Total2 = _interopRequireDefault(_Total);

	var _LoadMore = __webpack_require__(164);
	...
	var Layout = function (_React$Component) {
	  ...
	  */
	  function Layout(props) {
	    ...
	    _this.setReviews = _this.setReviews.bind(_this);
	  ...
	  */
	  ...
	  _createClass(Layout, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      var self = this;
	      var fetchReviews = fetch(this.state.url, { credentials: 'same-origin' });
	    ...
	    key: "resetReviews",
	    value: function resetReviews(data) {
	      // console.log("data received from URL is: ");
	      // console.log(data);
	      var reviewArr = [];
	      data.reviews.map(function (r) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "div",
	            { className: "col-xs-10" },
	            _react2.default.createElement(_LoadMore2.default, { handleLoadMore: this.handleLoadMore, peach: "fuzz" })
	          )
	        )
	      );
	    }
	  ...
	  */
	  ...
	  _createClass(Keyword, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        { style: divStyle, id: "componentKeyword" },
	        _react2.default.createElement(
	          "h6",
	          null,
	          "Filter by keyword"
	        ...
	        _react2.default.createElement("input", { className: "form-control", id: "inputKeyword", type: "text", onBlur: this.props.onBlur, ref: "newKeyword", placeholder: "enter keyword" })
	      );
	    }
	  }]);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "select",
	              { className: "form-control", value: this.props.rating, onChange: this.props.handleRating, id: "selectRating" },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReviewList = function (_React$Component) {
	  ...
	  function ReviewList() {
	    ...
	    var _this = _possibleConstructorReturn(this, (ReviewList.__proto__ || Object.getPrototypeOf(ReviewList)).call(this));
	  ...
	  _createClass(ReviewList, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      var reviewTypeList = {};
	      nextProps.reviews.forEach(function (review, index) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        { style: divStyle, id: "reviewList" },
	        Object.keys(this.state.reviewTypeList).map(function (key) {
	          return _react2.default.createElement(
	            "div",
	            { key: key },
	            _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _this2.state.reviewTypeList[key].map(function (review) {
	...
	var Total = function (_React$Component) {
	  ...
	  _createClass(Total, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        { style: divStyle, id: "componentTotal" },
	        _react2.default.createElement(
	          "label",
	          null,
	          "Showing ",
	  ...
	  _createClass(LoadMore, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { style: buttonStyle, onClick: this.props.handleLoadMore },
	          'Load More Reviews'
	        )
	      );
	    }
